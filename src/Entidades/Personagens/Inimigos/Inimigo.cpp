...
namespace Entidades { 
    namespace Personagens{
        ...
        Inimigo::Inimigo(const sf::Vector2f pos, const sf::Vector2f tam, float vel ,Jogador *jogador,const IDs ID) :
        Personagem(pos,tam,vel,ID),jogador1(jogador),atira(0), dtAux(0.0f)
        {
